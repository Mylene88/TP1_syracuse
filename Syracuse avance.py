...
class syracuse:
    ...
    def __init__(self,lecture,ecriture) -> None:
        self,lecture.txt = lecture.txt.txt
        self,ecriture.txt = ecriture.txt
   
    def lecture(self):
        try:
            fichier = open(self,lecture,"r")
        except:
            sys.exit("Impossible d'ouvrir le fichier "+self.lecture.txt)
    ...
    def ecriture.txt(self,param_1,param_2,param_3,param_4,param_5):

        try:
            fichier = open(self.ecriture.txt, "a")
        except:
            sys.exit("Impossible d'ouvrir le fichier "+self.lecture.txt.txt)
